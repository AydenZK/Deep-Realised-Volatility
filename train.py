...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--n_splits", type=int, default=3, help="Number of KFolds")
    parser.add_argument("--search_iter", type=int, default=10, help="Number of Grid Search Iterations")
